 ...
 * matteroverdrive.util.MatterHelper; import
 ...
 *//**
	 ...
	 *//*
		 ...
		 * te.getCapability(MatterOverdriveCapabilities.MATTER_HANDLER, null);
		 ...
		 * 
		 * } else { throw new
		 * RuntimeException("MOTileEntityMachineMatter WAILA provider is being used for something that is not a MOTileEntityMachineMatter: "
		 * + te.getClass()); }
		 * 
		 * return currenttip; }
		 * 
